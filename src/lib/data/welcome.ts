...
export const welcome = {
    introductionHTML: tString()
        .set('en', `My name is <span class="font-bold text-ocean dark:text-ocean-dark">Emir</span>, I'm a`)
        .set('it', `Mi chiamo <span class="font-bold text-ocean dark:text-ocean-dark">Emir</span>, sono un`),
    caption: tString()
