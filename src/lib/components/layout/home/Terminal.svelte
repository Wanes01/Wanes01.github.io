...
<div
	...
	class="cursor-auto overflow-hidden rounded-xl border border-carbon/10 bg-white/90
            font-fira opacity-0 shadow-lg shadow-carbon/30 {classes}"
>
	<!-- title bar -->
	<div
		class="relative flex items-center justify-end gap-1.5 border-b border-carbon/8 bg-carbon/5 px-3.5 py-2.5"
	>
		<p
	...
	<!-- terminal content -->
	<div class="p-4 text-[13.5px] leading-relaxed text-carbon">
		{@render children?.()}
	</div>
</div>
